...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  subtitle = "Transforming Decks.",
  description = "Trusted local professionals for exceptional deck building, construction, and outdoor living services. Get a free estimate today!",
